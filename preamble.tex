...
\usepackage{wrapfig}    % \wrapfigure command
...
% \newtheorem{tcorollary}[ttheorem]{Corollary}
\newtheorem{lemma}{Lemma}
% \newtheorem{tfact}[ttheorem]{Fact}
% \newtheorem{tproposition}[ttheorem]{Proposition}
% \newtheorem{tremark}{Remark}

% \theoremstyle{definition}
% \newtheorem{tdefinition}{Definition}
% \newtheorem*{tdefinition2}{Definition}
% \newtheorem{texercise}{Exercise}

% Rudin environment
% \newtheorem{rtheorem}{Theorem}[section]
% \newtheorem{rdefinition}[rtheorem]{Definition}
% \newtheorem*{rcorollary}{Corollary}
% \newtheorem{rlemma}[rtheorem]{Lemma}

% \newtheorem{rfact}[rtheorem]{Fact}
% \newtheorem{rproposition}[rtheorem]{Proposition}
% \newtheorem{rremark}[rtheorem]{Remark}

% \newtheorem*{rnote}{Note}
% \newtheorem{rexercise}{Exercise}[section]
...
\thmboxstyle{exrbox}{mdpurplebox}{pink!70!red}{pink!10!white}       % pink; exercise box
\thmboxstyle{sexrbox}{mdpinkbox}{pink!55!red}{pink!25!white}        % pink 2; exercise box
...
\declaretheorem[style = plain, name = Question,     numbered = yes]{ques}
...
\declaretheorem[style = sexrbox, name = Exercise,    numberwithin = exercise]{subexercise}
\declaretheorem[style = sexrbox, name = Exercise,    numberwithin = exercise]{subexerciseA}
\renewcommand{\thesubexerciseA}{\theexercise.\alph{subexerciseA}}

\declaretheorem[style = exrbox, name = Prompt,      numbered = no]{prompt}
\declaretheorem[style = exrbox, name = Instructions,      numbered = no]{instructions}
