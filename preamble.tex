...
%% Useful packages
\usepackage{amsmath}  % standard math stuff
\usepackage{amsthm}   % "
\usepackage{amssymb}  % "
\usepackage{amsfonts} % "
...
\usepackage{etoolbox}
\usepackage{xcolor}
\usepackage{microtype} %adjusts spacing
...
\usepackage[varqu,varl]{inconsolata} % cs390ATA
...
% Homework solution environment (red proof)
