...
\declaretheorem[style = thmbox, name = Theorem,     numberwithin = section]{btheorem}
\declaretheorem[style = thmbox, name = Lemma,       numberwithin = section]{blemma}
\declaretheorem[style = thmbox, name = Proposition, numberwithin = section]{bproposition}
\declaretheorem[style = thmbox, name = Corollary,   numberwithin = btheorem]{bcorollary}
\declaretheorem[style = thmbox, name = Conjecture,  numberwithin = section]{bconjecture}
\declaretheorem[style = thmbox, name = Algorithm,   numberwithin = section]{balgorithm}

\declaretheorem[style = thmbox, name = Theorem,     numbered = no]{btheorem*}
\declaretheorem[style = thmbox, name = Lemma,       numbered = no]{blemma*}
\declaretheorem[style = thmbox, name = Proposition, numbered = no]{bproposition*}
\declaretheorem[style = thmbox, name = Corollary,   numbered = no]{bcorollary*}
\declaretheorem[style = thmbox, name = Conjecture,  numbered = no]{bconjecture*}
\declaretheorem[style = thmbox, name = Algorithm,   numbered = no]{balgorithm*}

\declaretheorem[style = defbox, name = Definition,  numberwithin = section]{bdefinition}
\declaretheorem[style = defbox, name = Definition,  numbered = no]{bdefinition*}

\declaretheorem[style = exbox, name = Example,      numberwithin = section]{bexample}
\declaretheorem[style = exbox, name = Example,      numbered = no]{bexample*}
\declaretheorem[style = exbox, name = Non-Example,  numberwithin = section]{bnonexample}
\declaretheorem[style = exbox, name = Non-Example,  numbered = no]{bnonexample*}

\declaretheorem[style = exbox, name = Examples,     numbered = no]{bexamples}
\declaretheorem[style = exbox, name = Non-Examples, numbered = no]{bnonexamples}

\declaretheorem[style = ntbox, name = Remark,       numbered = no]{bremark}
\declaretheorem[style = ntbox, name = Fact,         numbered = no]{bfact}
\declaretheorem[style = ntbox, name = Note,         numbered = no]{bnote}
\declaretheorem[style = ntbox, name = Notation,     numbered = no]{bnotation}

\declaretheorem[style = plain, name = Question,     numbered = no]{bques}
\declaretheorem[style = plain, name = Answer,       numbered = no]{bans}
\declaretheorem[style = exrbox, name = Exercise,    numberwithin = section]{bexercise}
\declaretheorem[style = exrbox, name = Exercise,    numberwithin = bexercise]{bsubexercise}
\declaretheorem[style = exrbox, name = Prompt,      numberwithin = section]{bprompt}
\declaretheorem[style = ntbox, name = Problem,      numberwithin = section]{bproblem}
\declaretheorem[style = ntbox, name = Problem,      numbered = no]{bproblem*}
\declaretheorem[style = ntbox, name = Resources,    numbered = no]{bresources}
\declaretheorem[style = ntbox, name = Warning,      numbered = no]{bwarning}
