...
\newcommand{\thrt}{\ensuremath{\sqrt[3]}}
\newcommand{\fort}{\ensuremath{\sqrt[4]}}
\newcommand{\infrt}{\ensuremath{\sqrt[\infty]}}
...
% FALL 2024
  ...
  \newcommand{\Prob}{\bbP} % Probability
  \newcommand{\Exep}{\bbE} % Expected value
