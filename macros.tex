...
\newcommand{\FF}[1]{\ensuremath{\bbF_{#1}}}      % finite field of n elements
\newcommand*{\Ftw}{\ensuremath{\bbF_2}}     % finite field of 2 elements
\newcommand*{\Fth}{\ensuremath{\bbF_3}}     % finite field of 3 elements
\newcommand*{\Ffo}{\ensuremath{\bbF_4}}     % finite field of 4 elements
\newcommand*{\Ffi}{\ensuremath{\bbF_5}}     % finite field of 5 elements
\newcommand*{\Fsi}{\ensuremath{\bbF_6}}     % finite field of 6 elements
\newcommand*{\Fse}{\ensuremath{\bbF_7}}     % finite field of 7 elements
\newcommand*{\Fei}{\ensuremath{\bbF_8}}     % finite field of 8 elements
\newcommand*{\Fni}{\ensuremath{\bbF_9}}     % finite field of 9 elements
\newcommand*{\Fte}{\ensuremath{\bbF_{10}}}  % finite field of 10 elements
...
\newcommand{\ZZ}[1]{\ensuremath{\bbZ_{#1}}} % group of nonnegative integers < input under addition
\newcommand*{\Zn}{\ensuremath{\bbZ_n}}      % group of nonnegative integers < n under addition
\newcommand*{\Ztw}{\ensuremath{\bbZ_2}}     % group of nonnegative integers < 2 under addition
\newcommand*{\Zth}{\ensuremath{\bbZ_3}}     % group of nonnegative integers < 3 under addition
\newcommand*{\Zfo}{\ensuremath{\bbZ_4}}     % group of nonnegative integers < 4 under addition
\newcommand*{\Zfi}{\ensuremath{\bbZ_5}}     % group of nonnegative integers < 5 under addition
\newcommand*{\Zsi}{\ensuremath{\bbZ_6}}     % group of nonnegative integers < 6 under addition
\newcommand*{\Zse}{\ensuremath{\bbZ_7}}     % group of nonnegative integers < 7 under addition
\newcommand*{\Zei}{\ensuremath{\bbZ_8}}     % group of nonnegative integers < 8 under addition
\newcommand*{\Zni}{\ensuremath{\bbZ_9}}     % group of nonnegative integers < 9 under addition
\newcommand*{\Zte}{\ensuremath{\bbZ_{10}}}     % group of nonnegative integers less than 9 under addition
